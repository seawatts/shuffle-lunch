...
class ShuffleModel:
    def __init__(self, email_model, group_size, calendar_group_alias, recurring_event_id, name):
    ...
    def from_json(shuffle_json):
        ...
        return ShuffleModel(email_model, shuffle_json["groupSize"], shuffle_json["calendarGroupAlias"], shuffle_json["recurringEventId"], shuffle_json["name"])
